...
class _SendRequestDialogState extends State<SendRequestDialog> {
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: Text(
              ...
              style: const TextStyle(
                  fontSize: 13, height: 1.4, color: _kTextDark),
            ),
            actions: [
              TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      // insetPadding giúp dialog không sát mép màn hình
      insetPadding:
          const EdgeInsets.symmetric(horizontal: 24, vertical: 24),
      child: ConstrainedBox(
        constraints: BoxConstraints(
          maxWidth: 460,
          // Giới hạn chiều cao tối đa = 88% màn hình → tránh overflow
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        ...
                        style: TextStyle(
                            fontSize: 13, color: _kTextGray, height: 1.4),
                      ),
                      const SizedBox(height: 20),

                      // Mã bệnh nhân
                      const Text("Mã bệnh nhân (ID)",
                          style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
                              color: _kTextDark)),
                      ...
                      // Lý do yêu cầu
                      const Text("Lý do yêu cầu truy cập",
                          style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
                              color: _kTextDark)),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              "Nhập lý do lâm sàng cần xem lại tài liệu gốc...",
                          hintStyle: TextStyle(
                              color: _kTextGray.withOpacity(0.5),
                              fontSize: 13),
                          filled: true,
                          fillColor: _kBgLight,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                              color: _kWarningYellow.withOpacity(0.25)),
                        ),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Icon(Icons.warning_amber_rounded,
                                color: _kWarningYellow, size: 18),
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                    fontSize: 12,
                                    color:
                                        _kWarningYellow.withOpacity(0.95),
                                    height: 1.35),
                              ),
                            ),
                          ],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed:
                          _isLoading ? null : _handleExecuteRequest,
