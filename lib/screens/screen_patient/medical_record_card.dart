...
class _MedicalRecordCardState extends State<MedicalRecordCard> {
  ...
  Future<void> _downloadPdf() async {
    ...
    // Kiểm tra tính hợp lệ của Context trước khi tương tác UI
    if (!mounted) return;
    ...
    try {
      ...
      // KIỂM TRA LOGIC: Sau khi await, phải check !mounted để tránh crash app
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    // LOGIC SỬA ĐỔI: Ép kiểu an toàn cho Block Number (tránh lỗi int/string)
    final blockNumRaw = widget.record['blockNumber'];
    final blockNumStr = (blockNumRaw != null) ? blockNumRaw.toString() : '—';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isTampered ? _kWarning.withAlpha((0.3 * 255).round()) : Colors.grey.shade200,
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              color: isTampered ? _kWarning.withAlpha((0.1 * 255).round()) : _kSuccess.withAlpha((0.1 * 255).round()),
              child: Row(
                children: [
                  Icon(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _kPrimary.withAlpha((0.1 * 255).round()),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Truyền biến String đã xử lý an toàn vào đây
                          _buildBlockchainInfoRow("Block", blockNumStr),
                          const SizedBox(height: 6),
                          const Text(
                            "Mã giao dịch (TxHash):",
                            style: TextStyle(
