...
const Color _kPrimary = Color(0xFF2563EB); // Existing medical blue theme
...
class MedicalQAScreen extends ConsumerStatefulWidget {
  const MedicalQAScreen({super.key});

  @override
  ConsumerState<MedicalQAScreen> createState() => _MedicalQAScreenState();
}

class _MedicalQAScreenState extends ConsumerState<MedicalQAScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedFilter = ref.watch(qaFilterProvider);
    ...
    return Scaffold(
      ...
      body: SelectionArea(
        child: Column(
          children: [
            // ── TOP SECTION: Search Bar & Specialty Filter Chips ────────────
            Container(
              color: Colors.white,
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                            'Tìm kiếm câu hỏi, triệu chứng, chuyên khoa...',
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isSelected =
                            (item == "Tất cả" && selectedFilter == null) ||
                                (selectedFilter == item);
                        ...
                        return Padding(
                          ...
                          child: ChoiceChip(
                            ...
                            onSelected: (selected) {
                              if (selected) {
                                ref.read(qaFilterProvider.notifier).state =
                                    item == "Tất cả" ? null : item;
                              }
                            },
                          ...
                          const Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 16),
                                Text(
                                  "Chưa có câu hỏi tư vấn nào phù hợp.",
                                  style: TextStyle(
