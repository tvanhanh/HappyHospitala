...
class _MedicalRecordPageState extends State<MedicalRecordPage> {
  ...
  MedicalRecord record = MedicalRecord(
    ...
    status: "Mắc bệnh",
    doctorNote:
        "Cần theo dõi đường huyết thường xuyên", // Thêm giá trị cho doctorNote
    date: DateTime.now(),
  );
  ...
  void _editRecord(BuildContext context) {
    ...
    final _doctorNoteCtrl = TextEditingController(
        text: record.doctorNote); // Thêm controller cho doctorNote
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              title: Text(
                  'Ngày cập nhật: ${record.date.day}/${record.date.month}/${record.date.year}'),
            ),
          ],
        ),
      ),
