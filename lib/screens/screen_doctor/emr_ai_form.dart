...
class _EmrAiFormWidgetState extends State<EmrAiFormWidget> {
  ...
  // ================= TẤT CẢ LOGIC CŨ CỦA BẠN ĐƯỢC GIỮ NGUYÊN Ở ĐÂY =================
  ...
  Future<void> _runAIPrediction() async {
    ...
    try {
      ...
      final match = RegExp(r'Dự\s*đoán\s*[:=]\s*([^,}]+)', caseSensitive: false)
          .firstMatch(pred);
      if (match != null) {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      final response = await MedicalRecordService.addMedicalRecord(
        ...
        gender: widget.appointment.gender.isNotEmpty
      ...
      if (response == "success") {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("Thêm bệnh án EMR thành công!"),
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text("Lỗi: $response"), backgroundColor: Colors.red));
      }
    } catch (e) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Lỗi xảy ra: $e")));
    } finally {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        color: Color(0xFFF8FAFC), // Màu nền sáng, hiện đại
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Grid Nhập Liệu Hóa Sinh (Siêu gọn gàng)
                    Container(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color(0xFF8B5CF6), // Màu tím AI hiện đại
                    ...
                    if (_aiDiagnosisResult != null) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _aiSuggestedStatus.contains("Không")
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                                _aiSuggestedStatus.contains("Không")
                                    ? Icons.check_circle
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  const Color(0xFF0F172A), // Đen huyền bí mờ
  ...
  Widget _modernField(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: const Color(0xFFF1F5F9), // Màu xám rất nhạt
        contentPadding:
