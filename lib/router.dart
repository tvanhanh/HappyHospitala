...
import 'screens/screen_doctor/medical_record_page.dart';
...
import 'screens/screen_patient/doctor_detail_screen.dart';
...
import 'screens/screen_patient/patient_medical_records.dart';
...
import 'screens/screen_patient/medical_record_card.dart';
import 'screens/screen_patient/patient_medical_records.dart';
import 'screens/screen_patient/prediction_screen.dart';
import 'screens/screen_patient/profile_screen.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        return MedicalRecordPage(patient: patientData);
      },
    ),
    GoRoute(
    ...
    GoRoute(
      path: '/doctor-detail',
      builder: (context, state) {
        // Lấy dữ liệu bác sĩ từ extra
        // Nếu bạn dùng Map thì ép kiểu sang Map, nếu dùng Model thì ép kiểu sang DoctorModel
        final doctorData = state.extra as Doctor;

        return DoctorDetailScreen(doctor: doctorData);
      },
    ),
  ],
);
